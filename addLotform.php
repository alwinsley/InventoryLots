...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($input_lotstatus)){
        $lotstatus_err = "Please enter a Lotstatus.";
...
//closing date
    ...
    if(empty($input_createdBy)){
        $createdBy_err = "Please enter createdBy.";     
    } else{
...
//     }
    ...
    // Check input errors before inserting in database
            if(empty($city_err)){
                ...
                move_uploaded_file($surveytmp_name, $surveylocation.$surveyname);
        // Prepare an insert statement
        $sql = "INSERT INTO lottable (lotstatus, streetnumber, streetname, city, lotnumber, lotsize, lotcost, modelselection, permitstatus, ownedby, parcelid, floodzone, well, septic, streetpower, citywater, citysewer, propertyappraiser, listprice, purchaseprice, counteroffer, mls, seller, offersubmitteddate, contractsigneddate, escrowdue, escrowsubmitted, vetted, feasibilitydays, feasibilityduedate, closingdate,  notes, availabledate, permittingnotes, salesnotes, surveyname, surveysize, surveytype, surveylocation, createdBy) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
 
        if($stmt = mysqli_prepare($conn, $sql)){
            // Bind variables to the prepared statement as parameters
            mysqli_stmt_bind_param($stmt, "ssssssssssssssssssssssssssssssssssssssss", $param_lotstatus, $param_streetnumber, $param_streetname, $param_city, $param_lotnumber, $param_lotsize, $param_lotcost, $param_modelselection, $param_permitstatus, $param_ownedby, $param_parcelid, $param_floodzone, $param_well, $param_septic, $param_streetpower, $param_citywater, $param_citysewer, $param_propertyappraiser, $param_listprice, $param_purchaseprice, $param_counteroffer, $param_mls, $param_seller, $param_offersubmitteddate, $param_contractsigneddate, $param_escrowdue, $param_escrowsubmitted, $param_vetted, $param_feasibilitydays, $param_feasibilityduedate, $param_closingdate, $param_notes, $param_availabledate, $param_permittingnotes, $param_salesnotes, $param_surveyname, $param_surveysize, $param_surveytype, $param_surveylocation, $param_createdBy);
...
<!-- <p style="color:red">*Note: All fields must be completed. Put "NA" if not answered.</p> -->
                                <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="col-lg-4">
                                                ...
                                                <select class="form-control" value="<?php echo $lotstatus; ?>" id="lotstatus" name="lotstatus">
                                                        ...
                                                        <option value="Clear to Closed">Clear to Closed</option>
                                ...
                                <div class="form-group row <?php echo (!empty($modelselection_err)) ? 'has-error' : ''; ?>">
                                        ...
                                        <div class="col-lg-4 <?php echo (!empty($permitstatus_err)) ? 'has-error' : ''; ?>">
                                                ...
                                                <input type="text" class="form-control" value="<?php echo $permitstatus; ?>" name="permitstatus" id="permitstatus" placeholder="Permit Status">
                                        ...
                                        <div class="col-lg-4">
                                                ...
                                                <span style="color:red" class="help-block"><?php echo $well;?></span>
                                        </div>
                                        <div class="col-lg-4">
                                        ...
                                        <div class="col-lg-4">
                                                ...
                                                <span style="color:red" class="help-block"><?php echo $feasibilitydays_err;?></span>
                                        </div>
                                        <div class="col-lg-4">
                            ...
                            <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-lg-12">
                                                <label class="form-control-label">Add. Notes</label>
                                                <input type="text" rows="10" cols="10" class="form-control" value="<?php echo $notes; ?>" name="notes" id="notes" placeholder="Notes">
                        ...
                        <input type="file" name="survey" id="survey">
                                        ...
                                        <input type="hidden" rows="10" cols="10" class="form-control" value="<?php echo $createdBy; ?>" name="createdBy" id="createdBy">
